  ...
  return (
    <div className="container-fluid testimonials-container">
      <div className="text-center">
        ...
        <p className="text-muted-1 fs-4">
          Hear from real job seekers who have found <br /> success with our app.
        </p>
      </div>
      <div className="row justify-content-center mt-5">
        <div className="col-md-4 testimonial-box">
          <div className="testimonial-content">
            ...
            <p className="testimonial-text fs-4">
              "The job search feature on this app is amazing. I was able to find
              my dream job in just a few weeks!"
            </p>
          </div>
        </div>
        <div className="col-md-4 testimonial-box">
          <div className="testimonial-content">
            ...
            <p className="testimonial-text fs-4">
              "The resume builder tool is a game-changer. It helped me create a
              professional-looking resume that got me noticed."
            </p>
          </div>
        </div>
        <div className="col-md-4 testimonial-box">
          <div className="testimonial-content">
            ...
            <p className="testimonial-text fs-4">
              "The interview preparation tools on this app are fantastic. I felt
              so much more confident going into my interviews."
            </p>
          </div>
        </div>
      </div>
