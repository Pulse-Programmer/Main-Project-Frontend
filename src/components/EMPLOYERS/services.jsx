      ...
      <div className="container">
        <div className="row mt-5">
          <div className="col-md-6">
            <div className="services-image-placeholder">
              <img
                ...
                src="https://media.istockphoto.com/id/1202843504/photo/business-technology-internet-and-network-concept-technical-support-center-customer-service.jpg?s=612x612&w=0&k=20&c=E0cRrrLXV71xYzAtNgNYs4e8-XE12Nob9DGiJPp5DX8="
                alt=""
              />
            </div>
          </div>
          <div className="col-md-6">
            ...
            <p className="services-text">{services || "Loading services..."}</p>
