    ...
    <section className="job-seekers-section">
      <div className="container">
        ...
        <div className="payment-section">
          <p className="pay-p fs-4">To view the available job seekers, please make a payment.</p>
          <button
    ...
    <div className="modal-body">
      {selectedJobseeker && (
        <div>
          ...
          <p><strong>Job Category:</strong> {selectedJobseeker.job_category}</p>
            ...
            <div key={jobseeker.id} className="col-md-3">
              <div className="card job-seeker-card">
                <div className="card-body">
                  <h5 className="card-title fs-4"><span className="fw-normal fs-4">username:</span>{jobseeker.user.username}</h5>
                  ...
                  <button className="btn view-button btn-outline-primary mt-3" onClick={() => handleViewJobseeker(jobseeker.user_id)}>
                    View Profile
                  </button>
                  <button className="btn btn-primary cont-cutoon mt-2" onClick={() => handleContactJobseeker(jobseeker)}>Contact Me</button>
                </div>
              </div>
            </div>
          ))}
